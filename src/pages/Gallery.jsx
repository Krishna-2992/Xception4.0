      ...
      <>
        ...
        <section className="img-gallery">
          <div className="gallery">
            <div className="">
              <img
                src="https://techspodelhincr.in/wp-content/uploads/2020/01/TECHSPO-Delhi-NCR-2020.png"
                alt=""
              />
            </div>
            <div className="wide">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3-frpxMXYcBK9lgjYTv6Z_MX9i1l7mbLnMg&usqp=CAU"
                alt=""
              />
            </div>
            <div className="wide">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6RGgNspJoUrClD_Oa6-XRfGOSU-kdjLF4FA&usqp=CAU"
                alt=""
              />
            </div>
            <div className="">
              <img
                src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/tech-event-motion-poster-design-template-df7a48b3f947c2311df321e776cc3269.jpg?ts=1567082232"
                alt=""
              />
            </div>
            <div className="tall wide">
              <img
                src="https://img.freepik.com/free-vector/elegant-event-poster-with-black-splash_1361-2193.jpg?w=2000"
                alt=""
              />
            </div>
            <div className="wide">
              <img
                src="https://media.istockphoto.com/id/1153350345/photo/time-to-get-growing.jpg?b=1&s=170667a&w=0&k=20&c=rvLnZBe_WBVnF0AofEP3k0__q687hnGaZWGuGaVHM28="
                alt=""
              />
            </div>
            <div className="wide">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTt36Qaed5QifqWJB98i2FNA7h-Rs1OHfXPkA&usqp=CAU"
                alt=""
              />
            </div>
            <div className="wide">
              <img
                src="https://media.istockphoto.com/id/1325899588/photo/global-corporation-online-videoconference-in-meeting-room-with-diverse-people-sitting-in.jpg?s=170667a&w=is&k=20&c=1GkrJlZHjYgCtOP67FyY5wkSfcYWT5pLAkEKgC0QyK8="
                alt=""
              />
            </div>
            <div className="wide">
              <img
                src="https://blog.10times.com/wp-content/uploads/2022/10/event-technology-trend.jpeg"
                alt=""
              />
            </div>
            <div className="">
              <img
                src="https://cdn.ces.tech/ces/media/topics/cesfeaturedtopics_op2.jpg?ext=.jpg"
                alt=""
              />
            </div>
            <div className="">
              <img
                src="https://assets.publishing.service.gov.uk/government/uploads/system/uploads/image_data/file/171601/s300_Tech.png"
                alt=""
              />
            </div>
            <div className="">
              <img
                src="https://img.freepik.com/free-psd/vertical-poster-template-techno-store_23-2148979533.jpg?w=2000"
                alt="testing"
              />
            </div>
          </div>
